...
<div id="mini-cart" class="fixed top-0 right-0 w-80 h-full bg-white shadow-2xl transform translate-x-full transition-transform duration-300 ease-in-out z-50">
    <div class="flex flex-col h-full">
        ...
        <div id="cart-footer" class="border-t p-4 hidden">
            ...
            <div class="space-y-2">
                <a href="<?php echo e(route('cart')); ?>" class="block w-full bg-noorea-gold text-white py-2 rounded-lg hover:bg-yellow-600 transition-colors text-center">
...
<?php /**PATH C:\xampp\htdocs\noorea\resources\views/components/mini-cart.blade.php ENDPATH**/ ?>