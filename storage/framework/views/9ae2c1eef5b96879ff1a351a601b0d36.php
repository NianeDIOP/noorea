        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between">
                ...
                <a href="<?php echo e(route('home')); ?>" class="flex items-center group">
                    <img src="<?php echo e(asset('images/logo.svg')); ?>" alt="Noorea Beauty" class="h-8 w-auto">
                ...
                <div class="hidden md:flex flex-1 max-w-2xl mx-8">
                    <form class="w-full relative" action="<?php echo e(route('products')); ?>" method="GET">
                        <input 
                            type="search" 
                            name="search"
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="<?php echo e(route('cart')); ?>" class="navbar-icon-top relative" title="Mon panier">
            ...
            <div id="mobile-menu" class="md:hidden hidden bg-white/95 backdrop-blur-sm rounded-b-2xl shadow-xl border-t border-noorea-gold/20 mt-1">
                <div class="py-4 space-y-2">
                    ...
                    <div class="px-4 pb-4 border-b border-noorea-gold/20">
                        <form action="<?php echo e(route('products')); ?>" method="GET" class="relative">
                            <input 
                                type="search" 
                                name="search"
                                value="<?php echo e(request('search')); ?>"
                    ...
                    <!-- Liens navigation -->
                    <a href="<?php echo e(route('home')); ?>" class="nav-link-mobile <?php echo e(request()->routeIs('home') ? 'active-mobile' : ''); ?>">
                        <i class="fas fa-home mr-3 w-5"></i>Accueil
                    </a>
                    <a href="<?php echo e(route('products')); ?>" class="nav-link-mobile <?php echo e(request()->routeIs('products*') ? 'active-mobile' : ''); ?>">
                        <i class="fas fa-shopping-bag mr-3 w-5"></i>Boutique
                    </a>
                    <a href="<?php echo e(route('categories')); ?>" class="nav-link-mobile <?php echo e(request()->routeIs('categories*') ? 'active-mobile' : ''); ?>">
                        <i class="fas fa-th-large mr-3 w-5"></i>Catégories
                    </a>
                    <a href="<?php echo e(route('brands')); ?>" class="nav-link-mobile <?php echo e(request()->routeIs('brands*') ? 'active-mobile' : ''); ?>">
                        <i class="fas fa-crown mr-3 w-5"></i>Marques
                    </a>
                    <a href="<?php echo e(route('blog')); ?>" class="nav-link-mobile <?php echo e(request()->routeIs('blog*') ? 'active-mobile' : ''); ?>">
                        <i class="fas fa-feather-alt mr-3 w-5"></i>Magazine Beauté
                    </a>
                    <a href="<?php echo e(route('about')); ?>" class="nav-link-mobile <?php echo e(request()->routeIs('about*') ? 'active-mobile' : ''); ?>">
...
<?php /**PATH C:\xampp\htdocs\noorea\resources\views/components/unified-navbar.blade.php ENDPATH**/ ?>