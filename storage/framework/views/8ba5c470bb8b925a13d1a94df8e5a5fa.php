...
<head>
    ...
    <title><?php echo e(isset($title) ? $title . ' | ' : ''); ?>Mon Compte - Noorea</title>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="hidden md:flex items-center space-x-6">
                        <div class="text-right">
                            ...
                            <p class="font-semibold text-xl"><?php echo e(Auth::user()->name); ?></p>
                            <p class="text-sm text-yellow-100">Membre depuis <?php echo e(Auth::user()->created_at->format('M Y')); ?></p>
                        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div class="lg:col-span-1">
                    <div class="client-card p-6 sticky top-4">
                        ...
                        <nav class="space-y-1">
                            <a href="<?php echo e(route('account.dashboard')); ?>" class="client-nav-link <?php echo e(request()->routeIs('account.dashboard') ? 'active' : ''); ?>">
                                <i class="fas fa-chart-line"></i>
                                <span>Tableau de bord</span>
                            </a>
                            <a href="<?php echo e(route('account.profile')); ?>" class="client-nav-link <?php echo e(request()->routeIs('account.profile') ? 'active' : ''); ?>">
                                <i class="fas fa-user-edit"></i>
                                <span>Mon Profil</span>
                            </a>
                            <a href="<?php echo e(route('account.orders')); ?>" class="client-nav-link <?php echo e(request()->routeIs('account.orders*') ? 'active' : ''); ?>">
                                <i class="fas fa-shopping-bag"></i>
                                <span>Mes Commandes</span>
                            </a>
                            <a href="<?php echo e(route('account.wishlist')); ?>" class="client-nav-link <?php echo e(request()->routeIs('account.wishlist') ? 'active' : ''); ?>">
                                <i class="fas fa-heart"></i>
                                <span>Ma Liste de Souhaits</span>
                            </a>
                            <a href="<?php echo e(route('account.addresses')); ?>" class="client-nav-link <?php echo e(request()->routeIs('account.addresses') ? 'active' : ''); ?>">
                                <i class="fas fa-map-marker-alt"></i>
                                <span>Mes Adresses</span>
                            </a>
                            <a href="<?php echo e(route('account.security')); ?>" class="client-nav-link <?php echo e(request()->routeIs('account.security') ? 'active' : ''); ?>">
...
<?php /**PATH C:\xampp\htdocs\noorea\resources\views/account/layouts/client.blade.php ENDPATH**/ ?>