...
<?php $__env->startSection('title', 'Inscription - Noorea'); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="text-center">
                    <p class="text-sm text-gray-600">
                        Déjà un compte ?
                        <a href="<?php echo e(route('login')); ?>" class="font-medium text-noorea-gold hover:text-yellow-600">
                            Se connecter
                        </a>
                    </p>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\noorea\resources\views/auth/register.blade.php ENDPATH**/ ?>