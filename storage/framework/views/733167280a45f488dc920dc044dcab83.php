...
<head>
    ...
    <!-- Styles -->
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/css/noorea.css']); ?>
        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                <div class="flex justify-center mb-6">
                    <div class="relative">
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Noorea" class="h-16 w-auto">
                ...
                <form method="POST" action="<?php echo e(route('admin.login')); ?>" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            required 
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-noorea-gold focus:border-noorea-gold transition-colors bg-white/50 backdrop-blur-sm <?php $__errorArgs = ['email'];
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input 
                                ...
                                id="password" 
                                required 
                                class="w-full px-4 py-3 pr-12 border border-gray-300 rounded-xl focus:ring-2 focus:ring-noorea-gold focus:border-noorea-gold transition-colors bg-white/50 backdrop-blur-sm <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
<?php /**PATH C:\xampp\htdocs\noorea\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>