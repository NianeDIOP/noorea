...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <?php if(session('warning')): ?>
        showWarningToast(`<?php echo e(session('warning')); ?>`);
    <?php endif; ?>

    <?php if(session('info')): ?>
        showInfoToast(`<?php echo e(session('info')); ?>`);
    <?php endif; ?>

    <?php if($errors->any()): ?>
        <?php if($errors->count() === 1): ?>
            showErrorToast(`<?php echo e($errors->first()); ?>`, 'Erreur de validation');
        <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\noorea\resources\views/admin/components/notifications.blade.php ENDPATH**/ ?>