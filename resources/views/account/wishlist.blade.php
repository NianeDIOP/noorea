...
@section('title', 'Ma Liste de Souhaits - Noorea')
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-md">
            ...
            <div class="text-center py-16">
                ...
                <a href="{{ route('products') }}" class="inline-flex items-center px-6 py-3 bg-noorea-gold text-white rounded-lg hover:bg-yellow-500 transition-colors">
        ...
        <div class="mt-8 text-center">
            <div class="space-x-4">
                <a href="{{ route('products') }}" class="inline-flex items-center px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
                    <i class="fas fa-arrow-left mr-2"></i>
                    Continuer mes achats
                </a>
                <a href="{{ route('cart') }}" class="inline-flex items-center px-6 py-3 bg-noorea-gold text-white rounded-lg hover:bg-yellow-500 transition-colors">
