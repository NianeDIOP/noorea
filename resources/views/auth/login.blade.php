...
@section('title', 'Connexion - Noorea')
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <form class="space-y-6" action="#" method="POST">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('password.request') }}" class="text-sm text-noorea-gold hover:text-yellow-600">
                        Mot de passe oublié ?
                    </a>
                </div>
                ...
                <div class="text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="{{ route('register') }}" class="font-medium text-noorea-gold hover:text-yellow-600">
                            Créer un compte
                        </a>
                    </p>
                </div>
