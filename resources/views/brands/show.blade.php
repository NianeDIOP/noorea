    ...
    <div class="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <nav class="text-sm mb-8">
            <ol class="flex items-center space-x-2 text-noorea-dark/70">
                ...
                <li><i class="fas fa-chevron-right text-noorea-gold/50 text-xs"></i></li>
                <li class="text-noorea-dark font-medium">{{ $brand->name }}</li>
            </ol>
        </nav>

        <!-- En-tête avec informations de la marque -->
        <div class="mb-8 md:mb-12">
            <div class="text-center lg:text-left">
                <!-- Logo de la marque -->
                <div class="flex justify-center lg:justify-start mb-6">
                    @if($brand->logo_url)
                        <div class="w-24 h-24 rounded-2xl overflow-hidden border-4 border-noorea-gold/20 shadow-lg bg-white flex items-center justify-center p-2">
                            <img src="{{ $brand->logo_url }}" alt="{{ $brand->name }}" class="max-w-full max-h-full object-contain">
                        </div>
                    @else
                        <div class="w-24 h-24 bg-gradient-to-br from-noorea-gold to-noorea-rose-gold rounded-2xl flex items-center justify-center shadow-lg">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                    <div>
                        <h2 class="text-4xl font-serif font-light text-noorea-dark mb-2 tracking-wide">
                            {{ $brand->name }}
                        </h2>
                        @if($brand->country)
                            <p class="text-noorea-gold font-medium mb-4 flex items-center justify-center lg:justify-start">
                    ...
                    <div class="flex flex-wrap gap-2 justify-center lg:justify-end">
                        @if($brand->is_featured)
                            <div class="bg-noorea-gold text-white px-3 py-1 rounded-full text-sm font-medium flex items-center">
                                <i class="fas fa-star mr-1"></i> Marque Premium
                            </div>
                        @endif
                        @if($brand->website)
                            <a href="{{ $brand->website }}" target="_blank" class="bg-noorea-emerald text-white px-3 py-1 rounded-full text-sm font-medium flex items-center hover:bg-noorea-emerald/80 transition-colors">
        ...
        @else
            ...
            <div class="text-center py-20">
                ...
                <h3 class="text-2xl font-serif font-medium text-noorea-dark mb-4">Aucun produit de cette marque</h3>
                <p class="text-noorea-dark/70 mb-8 max-w-md mx-auto">
                    La marque "{{ $brand->name }}" ne propose pas encore de produits dans notre boutique.
                </p>
                <a href="{{ route('brands') }}" 
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Marque chargée - Version SIMPLE');
